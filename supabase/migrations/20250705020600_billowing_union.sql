/*
  # Add public questions support

  1. New Columns
    - `is_public` (boolean) - Whether the question is visible to all users
  
  2. Security
    - Update RLS policy to allow viewing public questions
    - Add index for performance on public questions queries
  
  3. Changes
    - Add is_public column with default false
    - Create index for better query performance
    - Update SELECT policy to handle public questions access
*/
